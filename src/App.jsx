...
function PinGate({ onVerified }) {
  ...
  return (
    <div style={{
      ...
      background: 'linear-gradient(135deg, #0a0a0f 0%, #13131a 50%, #0d0d14 100%)',
      display: 'flex', alignItems: 'center', justifyContent: 'center'
    }}>
      <div style={{
        background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(24px)',
        border: '1px solid rgba(255,255,255,0.1)', borderRadius: '20px',
        padding: '40px 36px', width: '90%', maxWidth: '380px', textAlign: 'center',
        boxShadow: '0 24px 64px rgba(0,0,0,0.6)'
      }}>
        {/* Logo */}
        <div style={{ fontSize: '22px', fontWeight: 800, letterSpacing: '3px', color: '#E50914', marginBottom: '28px' }}>
          CINESTREAM
        </div>
        ...
        <p style={{ margin: '0 0 28px', fontSize: '13px', color: 'rgba(255,255,255,0.45)', lineHeight: 1.5 }}>
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            style={{
              ...
              borderRadius: '10px', padding: '16px', color: 'white',
              fontSize: '28px', letterSpacing: '18px', textAlign: 'center',
          ...
          />
          {error && (
            <p style={{ color: '#E50914', fontSize: '13px', margin: '0 0 12px' }}>{error}</p>
          )}
          <button
            type="submit"
            ...
            style={{
              ...
              background: pin.length === 4 ? 'linear-gradient(135deg, #E50914 0%, #ff4444 100%)' : 'rgba(255,255,255,0.08)',
              color: pin.length === 4 ? 'white' : 'rgba(255,255,255,0.3)',
              fontSize: '15px', fontWeight: 700, cursor: pin.length === 4 ? 'pointer' : 'not-allowed',
              transition: 'all 0.2s', letterSpacing: '0.5px',
              boxShadow: pin.length === 4 ? '0 4px 20px rgba(229,9,20,0.4)' : 'none'
            }}
          >
            Unlock
          </button>
